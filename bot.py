...
# TODO  this part, we made the changs for getting more information
...
def create_card_response(event_message): 
    ...
    cards = list()
    widgets = list()
    # Undo this, once other things started to work out.
    payload = {"message":event_message }
    
    r = requests.post('https://us-central1-proj-chatbot-og.cloudfunctions.net/dialogflow_support', json=payload)
    result = str(r.text)
...
def create_card_response1(event_message):
